  ...
  return (
    <div className="p-8 max-w-md mx-auto">
      ...
      <form onSubmit={submit} className="flex flex-col gap-3">
        <input className="border p-2" placeholder="Business Name" value={businessName} onChange={e=>setBusinessName(e.target.value)} />
        <input className="border p-2" placeholder="Full Name" value={fullName} onChange={e=>setFullName(e.target.value)} />
        ...
        <button className="bg-blue-500 text-white p-2" type="submit">Sign Up</button>
      </form>
    </div>
  );
}